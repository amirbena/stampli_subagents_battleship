...
The skill will ask what you want to build, clarify any gaps with up to 4 questions, write `requirements.md`, show it to you for confirmation, then automatically launch the full pipeline. No further input needed.
...
## Reports
Generated by the pipeline into [`reports/`](reports/). This folder is gitignored — reports are process artifacts and do not belong in PRs.
